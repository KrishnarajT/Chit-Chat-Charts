...
# This could technically have also been possible without classes, but the alternative was to define a bunch of variables, lists and dataframes
# that were used throughout the code; in the global scope. This would look messy, would still work but class solution was expandable and seemed
# to make sense at this time for interconnectivity between the different functions, as they could use the same variables. 
class read:
    ...
    def messages_daily(self): 
        ...
        plt.legend(loc = 'best')
        plt.savefig(f'{self.graphDestPath}{self.person1} with {self.person2} Messages Sent Daily.jpg')
        plt.clf()
